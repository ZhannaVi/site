...
if ( ! class_exists( 'Boutique_Designer_Shop_WPTT_WebFont_Loader' ) ) {
	/**
	 * Download webfonts locally.
	 */
	class Boutique_Designer_Shop_WPTT_WebFont_Loader {
...
if ( ! function_exists( 'wptt_get_webfont_styles' ) ) {
	...
	function wptt_get_webfont_styles( $url, $format = 'woff2' ) {
		$font = new Boutique_Designer_Shop_WPTT_WebFont_Loader( $url );
