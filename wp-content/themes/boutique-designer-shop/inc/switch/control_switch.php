 ...
 * Control - Switch.
 *
 * @package Boutique Designer Shop Themes
 */

if( class_exists( 'WP_Customize_Control' ) ) {
	class Boutique_Designer_Shop_Customizer_Customcontrol_Switch extends WP_Customize_Control {
		...
		public function enqueue() {
			...
			wp_enqueue_script( 'boutique-designer-shop-control-switch', trailingslashit( get_template_directory_uri() ) . 'inc/switch/control_switch.js', array( 'jquery' ) );

			wp_enqueue_style( 'boutique-designer-shop-control-switch', trailingslashit( get_template_directory_uri() ) . 'inc/switch/control_switch.css', '', time() );
