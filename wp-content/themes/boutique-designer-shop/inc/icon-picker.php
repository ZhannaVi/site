...
class Boutique_Designer_Shop_Fontawesome_Icon_Chooser extends WP_Customize_Control{
    public $type = 'icon';
        ...
        ?>
            <label>
                ...
                <div class="social-icon-search">
                    <input class="socialInput" type="text" placeholder="<?php echo esc_attr_x( 'Icon', 'placeholder', 'boutique-designer-shop' ); ?>">
                </div>
                ...
                <ul class="icon-list clearfix">
                    <?php
                    $boutique_designer_shop_font_awesome_icon_array = boutique_designer_shop_font_awesome_icon_array();
                    foreach ($boutique_designer_shop_font_awesome_icon_array as $boutique_designer_shop_font_awesome_icon) {
                            $icon_class = $this->value() == $boutique_designer_shop_font_awesome_icon ? 'icon-active' : '';
                            echo '<li class='.esc_attr($icon_class).'><i class="'.esc_attr($boutique_designer_shop_font_awesome_icon).'"></i>
                            <span class="boutique-designer-shop-social-class">'.esc_attr($boutique_designer_shop_font_awesome_icon).'</span>
                            </li>';
                        }
                    ?>
                </ul>
...
function boutique_designer_shop_customizer_script() {
     
    wp_enqueue_style( 'font-awesome-1', esc_url(get_template_directory_uri()).'/assets/css/fontawesome-all.css');
    wp_enqueue_script( 'boutique-designer-shop-customizer-script', esc_url(get_template_directory_uri()).'/assets/js/customizer-scripts.js', array("jquery"),'', true  );
}
add_action( 'customize_controls_enqueue_scripts', 'boutique_designer_shop_customizer_script' );

if(!function_exists('boutique_designer_shop_font_awesome_icon_array')){
    function boutique_designer_shop_font_awesome_icon_array(){
